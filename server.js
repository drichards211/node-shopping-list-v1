...
const {Recipes} = require('./models'); //DR
...
Recipes.create('mojito', ['soda', 'rum', 'mint', 'lime', 'sugar'])
Recipes.create('guacamole', ['avocado', 'onion', 'jalapeno', 'lime', 'salt'])
